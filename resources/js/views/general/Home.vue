...
import FacilityCarouselOptions from "../../components/FacilityCarouselOptions.vue";

export default {
    components: {
        BaseLayout,
        FacilityCarousel: FacilityCarouselOptions,
    },
    data() {
        return {
            articles: []
                ...
                <div class="p-8">
                    ...
                    <div>
                        <p class="text-4xl font-libertius-serif text-black italic">
                            “ Mewujudkan SMK berbudaya kerja, menghasilkan lulusan profesional yang beriman dan bertakwa kepada Tuhan YME,
                            berakhlak mulia, berkarakter unggul, dan berjiwa kompetitif. ”
                        </p>
                    </div>
                </div>
                <div class="p-8">
                    ...
                    <div class="flex">
                        <router-link :to="{ name: 'Articles Page' }"
